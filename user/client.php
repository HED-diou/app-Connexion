                ...
                <?php 
                        ...
                        if(isset($_GET['err'])){
                            ...
                            switch($err){
                                ...
                                break; 
                                case 'success_avatar':
                                    echo "<div class='alert alert-success'>L'avatar a bien été modifié ! </div>";
                                break; 
                                case 'current_avatar_size':
                                    echo "<div class='alert alert-danger'>La taille du fichier est superieur a 20Mo ! </div>";
                                break; 
                                case 'current_avatar_extention':
                                    echo "<div class='alert alert-danger'>L'extention n'est pas pris en compt [jpg , jpeg , gif , png] ! </div>";
                                break; 
                                case 'current_avatar_uncoin':
                                    echo "<div class='alert alert-danger'>Ereur inconue ! </div>";
                                break; 
                            }
                        }
                        //
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Changer mon mot de passe</h5>
                            ...
                            <div class="modal-body">
                                <form action="exec/change_password.php" method="POST">
            ...
            <div class="modal fade" id="avatar" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="exec/change_avatar.php" method="POST" enctype="multipart/form-data">
