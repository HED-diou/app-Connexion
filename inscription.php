    ...
    <html lang="fr">
        ...
        <div class="login-form">
                    ...
                    switch($err)
                    {
                        ...
                        ?>
                            <div class="alert alert-danger">
                                <strong>Erreur</strong> veuillez verifier vos informations
                            </div>
                        <?php
                        break;
                        ...
                        ?>
                            <div class="alert alert-danger">
                                <strong>Erreur</strong> Ce Pseudo ou email deja existant
                            </div>
                        <?php 
                        break;
            ...
            <form action="inscription_traitement.php" method="post">
                ...
                <div class="form-group">
                    <input type="password" name="pass_retype" class="form-control" placeholder="Re-tapez le mot de passe" required="required" autocomplete="off">
                </div>
                <div class="form-group">
